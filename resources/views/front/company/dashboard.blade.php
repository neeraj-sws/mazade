                  ...
                  <div class="tab-content" id="v-pills-tabContent">
                     ...
                     <div class="tab-pane fade active show" id="v-pills-last-order-2" role="tabpanel" aria-labelledby="v-pills-last-order-2">
                        <div class="dashboard-area box--shadow">
                           <div class="row g-4">
                              <a href="{{route('wallethistory')}}" id="walletHistory" > 
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay=".6s">
                                    <div class="header">
                                       <h5>Total sales</h5>
                                    </div>
                                    <div class="body">
                              ...
                              <div class="col-md-6 col-sm-6">
                                 <div class="dashboard-card hover-border1 wow fadeInDown" data-wow-duration="1.5s" data-wow-delay=".8s">
                                    <div class="header">
                                       <h5>participating in auctions </h5>
                                    </div>
                                    <div class="body">
                                       <div class="counter-item">
                                          <h2>{{$auctioncount}}</h2>
                     ...
                     <div class="tab-pane fade" id="v-pills-order-2" role="tabpanel" aria-labelledby="v-pills-order-tab-2">
                        <div class="dashboard-area box--shadow">
                           <div class="table-title-area">
                     ...
                     <div class="tab-pane fade" id="v-pills-order-3" role="tabpanel" aria-labelledby="v-pills-order-tab-3">
                        <div class="dashboard-area box--shadow">
                           <div class="table-title-area">
                     ...
                     <div class="tab-pane fade" id="v-pills-last-order" role="tabpanel" aria-labelledby="v-pills-last-order">
                        <div class="dashboard-area box--shadow">
                           <div class="table-title-area">
                              <h3>Last Orders</h3>
                              <select>
                     ...
                     <div class="tab-pane fade" id="withdarw-history" role="tabpanel" aria-labelledby="withdarw-history-tab">
                        <div class="dashboard-area box--shadow">
                           <div class="table-title-area">
