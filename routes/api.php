...
Use App\Http\Controllers\API\Client\{ClientAuthController,ClientInfoController,ClientServicesController,ClientHolidayController,ClientSlotController,ClientAppointmentController};
...
Route::group(['middleware' => ['auth:sanctum','ability:client']], function() {
    ...
    Route::post('client/info',[ClientInfoController:: class, 'clientInfo']);
    Route::get('client/category-list',[ClientInfoController:: class, 'clientCategory']);
    Route::get('client/cities-list',[ClientInfoController:: class, 'Cities']);
    ...
    Route::get('client/get-services',[ClientServicesController:: class, 'getServices']);
