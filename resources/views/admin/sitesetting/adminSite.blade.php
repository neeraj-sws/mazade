                            ...
                            <div class="row content-min-height">
                                <div class="p-0 column-panel border-end" style="max-width: 230px; min-width: 230px; left: -230px;">
                                    ...
                                    <div class="columns-panel-item-group">
                                        ...
                                        <a class="columns-panel-item columns-panel-item-link " id="site" onclick="admin('{{ $route->sitesettingAdmin}}','{{ $info->id }}','adminSite');return false;" href="javascript:void(0);">
                                    ...
                                    <div class="card-body" id="editsite">
                                        <div class="mb-4 d-md-flex align-items-center justify-content-between">
                                            <div>
                                                ...
                                                <p>Basic info, Image Name and address on this account.</p>
                                            </div>
