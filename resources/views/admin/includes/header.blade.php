                             ...
                             <img src="" alt="logo">
                                ...
                                <div class="dropdown-menu dropdown-menu-end">
                                    ...
                                    <a href="{{ route('admin.admins.adminProfile',['id' => Auth::guard('admin')->user()->id]) }}"   class="dropdown-item">
                                     ...
                                     <a href="{{ route('admin.sitesetting.adminSite',['id' => Auth::guard('admin')->user()->id]) }}"   class="dropdown-item">
                                        <div class="d-flex align-items-center">
                                            <i class="font-size-lg me-2 fas fa-user-cog"></i>
