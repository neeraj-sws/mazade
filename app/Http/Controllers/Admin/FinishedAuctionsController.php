...
use App\Models\{Auctionitems,Upload,Category,Oders,Auction};
use Illuminate\Http\Request;
use App\Models\Startauction;

class FinishedAuctionsController extends Controller
{
    /**
    ...
    public function __construct()
    {
          ...
          $this->single_heading = "Finished Auctions";
          $this->route->list = route('admin.finished.list');
    }
