   ...
   <table class="eg-table order-table table mb-0" id="categories_filter">
      ...
      <tbody>
         ...
         @else
            ...
            <td data-label="Action"><a href="javascript:void(0);" class="cancel-btn"  onclick="seller_status_change('{{ route('seller-auction-bit') }}','1', {{ $auctions->id }},'Cancel')"><button class="cancel-btn text-nowrap"><i class="fas fa-times" aria-hidden="true"></i> Cancel</button></a></td> 
