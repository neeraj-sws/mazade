...
@section('content')
                    ...
                    <div class="card-body">
                        <div class="m-2">
                            ...
                            <div class="alert alert-danger">
                                ...
                                @endif --}}
                                <form class="row g-3" action="{{ route('login.companies') }}" method="POST" onsubmit="event.preventDefault();companyLogin_submit(this);return false;" enctype="multipart/form-data">
 ...
 <script>
    function companyLogin_submit(e) {
    toastr.clear();
   ...
   $.ajax({
     ...
     success: function (data) {
       ...
       if (data.status == 1) {
        ...
        window.location.href = base_url+'companies/dashboard';
