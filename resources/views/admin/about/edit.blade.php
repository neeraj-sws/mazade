            ...
            <form class="row g-3" action="{{$route->store}}"
                ...
                <div class="col-md-10">
                   ...
                   <div class="custom-file">
                       <input type="hidden" name="image_path" value="uploads/about/">
                ...
                <div class="col-md-2 mt-3">
                    @if($info->headerImage)
                    <img src="{{asset('uploads/about/'.$info->headerImage->file)}}" id="image_prev"
               ...
               <div class="col-md-10">
                ...
                <div class="custom-file">
                    <input type="hidden" name="path" value="uploads/about/">
                ...
                <div class="col-md-2 mt-3">
                    @if($info->photo)
                    <img src="{{asset('uploads/about/'.$info->photo->file)}}" id="image_pdf_prev"
                        class="img-thumbnail " alt="" width="100" height="100">
                    @else
